...
import com.zhenyu.common.constant.AutoFillConstant;
...
/**
 * 公共字段自动填充切面（AOP）
 * 拦截带有 @AutoFill 注解的方法，自动填充 createTime、updateTime、createUser、updateUser
 */
@Aspect
@Component
@Slf4j
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.zhenyu.drama.mapper.*.*(..)) && @annotation(com.zhenyu.drama.annotation.AutoFill)")
